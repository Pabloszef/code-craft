...
import ProPlanView from "@/app/pricing/_components/ProPlanView";
import NavigationHeader from "@/components/NavigationHeader";
import {ENTERPRISE_FEATURES, FEATURES} from "@/app/pricing/_constants";
...
import UpgradeButton from "@/app/pricing/_components/UpgradeButton";
                        ...
                        {ENTERPRISE_FEATURES.map((feature) => (
                            ...
                            >
                                <div className="relative">
                                    <div className="size-12 rounded-xl bg-gradient-to-br from-blue-500/10 to-purple-500/10
                        ...
                        <div className="relative bg-[#12121a]/90 backdrop-blur-xl rounded-2xl">
                            ...
                            {/* header */}
                                <div className="text-center mb-12">
                                    <div className="inline-flex p-3 rounded-xl bg-gradient-to-br from-blue-500/10 to-purple-500/10
                                    ring-1 ring-gray-800/60 mb-6">
                                    ...
                                    <div className="flex items-baseline justify-center gap-2 mb-4">
                                        ...
                                        <span className="text-6xl font-semibold bg-gradient-to-r from-gray-100 to-gray-300
