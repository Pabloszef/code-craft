...
import ProfileHeaderSkeleton from "@/app/profile/_components/ProfileHeaderSkeleton";
import {ChevronRight, Clock, Code, ListVideo, Loader2, Star} from "lucide-react";
import {AnimatePresence, motion} from "framer-motion";
import Image from "next/image";
import CodeBlock from "@/app/profile/_components/CodeBlock";
...
function ProfilePage() {
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0f]">
            ...
            {/* Main content */}
                <div
                    className="bg-gradient-to-br from-[#12121a] to-[#1a1a2e] rounded-3xl shadow-2xl shadow-black/50
                        ...
                        <div className="flex space-x-1 p-4">
                            {TABS.map((tab) => (
                                <button
                                    ...
                                    className={`group flex items-center gap-2 px-6 py-2.5 rounded-lg transition-all
                                ...
                                <div className="space-y-6">
                                    {executions?.map((execution) => (
                                        <div
                                            ...
                                            hover:border-blue-500/50 hover:shadow-md hover:shadow-blue-500/50"
                                        >
                                            <div className="flex items-center justify-between p-4 bg-black/30 border
                                            border-gray-800/50 rounded-t-xl">
                                                <div className="flex items-center gap-4">
                                                    <div className="relative">
                                                        <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-500
                                                        rounded-lg blur opacity-20 group-hover:opacity-30 transition-colors"/>
                                                        <Image
                                            ...
                                            <div className="p-4 bg-black/20 rounded-b-xl border border-t-0 border-gray-800/50">
                                                <CodeBlock language={execution.language} code={execution.code} />
                                    ...
                                    {isLoadingExecutions ? (
                                        ...
                                        executions.length === 0 && (
                                            <div className='text-center py-12'>
                                                ...
                                                <p>Start coding to see your execution history!</p>
                                            </div>
                                        )
                                    )}
                                    ...
                                    {executionsStatus === "CanLoadMore" && (
                                        <div className="flex justify-center mt-8">
                                            <button
                                                ...
                                                className="px-6 py-3 bg-blue-500/10 hover:bg-blue-500/20 text-blue-400
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {starredSnippets?.map((snippet) => (
                                        <div key={snippet._id} className="group relative">
                                            <Link href={`/snippets/${snippet._id}`}>
                                                <div
                                                    className="bg-black/20 rounded-xl border border-gray-800/50
                                                    hover:border-gray-700/50 transition-all duration-300 overflow-hidden
                                                    h-full group-hover:transform group-hover:scale-[1.02] "
                                                >
                                                    <div className="p-6">
                                                        <div className="flex items-center justify-between mb-4">
                                                            <div className="flex items-center gap-3">
                                                                <div className="relative">
                                                                    ...
                                                                    to-purple-500 rounded-lg blur opacity-20 group-hover:opacity-30 transition-opacity"/>
                                                                    <Image
                                                        ...
                                                        <h2 className="text-xl font-semibold text-white mb-3 line-clamp-1
                                                        ...
                                                        <div className="flex items-center justify-between text-sm text-gray-400">
                                                            ...
                                                            <ChevronRight className="size-4 transform group-hover:translate-x-1
                                    ...
                                    {(!starredSnippets || starredSnippets.length === 0) && (
                                        <div className="col-span-full text-center py-12">
                                            <Star className="size-12 text-gray-600 mx-auto mb-4"/>
                                            <h3 className="text-lg font-medium text-gray-400 mb-2">
