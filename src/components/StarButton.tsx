...
const StarButton = ({snippetId}: {snippetId: Id<"snippets">}) => {
    ...
    return (
        <button className={`group flex items-center gap-1.5 px-3 py-1.5 rounded-lg transition-all duration-200 ${
            isStarred
        ...
        onClick={handleStar}
        >
            <StarIcon className={`size-4 ${isStarred ? "fill-yellow-500" : "fill-none group-hover:fill-gray-400"}`}/>
